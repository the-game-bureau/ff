...
const VICTIMS_SUPABASE_URL = VICTIMS_CONFIG.url || 'https://vkoczgzizzppdrpvpemh.supabase.co';
const VICTIMS_SUPABASE_ANON_KEY = VICTIMS_CONFIG.publishableKey || 'sb_publishable_XfvD3zCvnCHT1v_EGE-LJA_3Z9bGjKw';
